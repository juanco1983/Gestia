...
async function main() {
  ...
  const users = [
    { id: 'user_0', username: 'Administrador General', email: 'admin@mafort.pe', password: hash, role: 'Administrador', estado: 'Activo', area: 'Administración General', ultimoIngreso: '2026-06-29 08:00', creadoEn: '2026-01-01', allowedModules: ['Dashboard','Monitoreo','GestionOTs','ClientesContratos','Ventas','Tecnico','Supervisor','Cliente','Usuarios'] },
    { id: 'user_1', username: 'María López', email: 'ventas@mafort.pe', password: hash, role: 'Ventas', estado: 'Activo', area: 'Planeamiento Comercial', ultimoIngreso: '2026-06-29 08:15', creadoEn: '2026-01-10', allowedModules: ['Dashboard','Monitoreo','GestionOTs','ClientesContratos','Ventas'] },
    { id: 'user_2', username: 'Carlos Ocsa', email: 'carlos.ocsa@mafort.pe', password: hash, role: 'Tecnico', estado: 'Activo', area: 'Mantenimiento de Campo', ultimoIngreso: '2026-06-29 07:30', creadoEn: '2026-01-12', allowedModules: ['Dashboard','Monitoreo','Tecnico'] },
    { id: 'user_3', username: 'Ing. Roberto Salas', email: 'supervisor@mafort.pe', password: hash, role: 'Supervisor', estado: 'Activo', area: 'Control de Calidad (SLA)', ultimoIngreso: '2026-06-29 08:05', creadoEn: '2026-01-15', allowedModules: ['Dashboard','Monitoreo','Supervisor'] },
  ...
  const contratosNuevos = [
    { id: 'cont_001', cliente: 'Prosegur Tecnología S.A.', ot_marco: 100, tipo_servicio: 'CONTRATO', tipo_contrato: 'Mantenimiento Preventivo UPS 60KVA + 100KVA', fecha_inicio: '2026-01-01', fecha_fin: '2026-12-31', estado: 'VIGENTE', comercial: 'María López', comentarios: '4 visitas anuales programadas', clientId: 'client_1', comercialId: 'user_1' },
    { id: 'cont_002', cliente: 'Clínica San Pablo S.A.C.', ot_marco: 200, tipo_servicio: 'CONTRATO', tipo_contrato: 'Mantenimiento Preventivo UPS 40KVA', fecha_inicio: '2026-01-15', fecha_fin: '2027-01-14', estado: 'VIGENTE', comercial: 'María López', comentarios: '6 visitas anuales', clientId: 'client_2', comercialId: 'user_1' },
    { id: 'cont_003', cliente: 'Banco Interbank S.A.', ot_marco: 300, tipo_servicio: 'CONTRATO', tipo_contrato: 'Climatización 80HP + Rectificador 120KVA', fecha_inicio: '2026-03-01', fecha_fin: '2027-02-28', estado: 'VIGENTE', comercial: 'María López', comentarios: 'Mantenimiento mensual', clientId: 'client_3', comercialId: 'user_1' },
  ];
