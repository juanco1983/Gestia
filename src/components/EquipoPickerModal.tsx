...
export default function EquipoPickerModal({
  ...
  return createPortal(
    <>
    <div className="fixed inset-0 bg-slate-900/50 backdrop-blur-sm" style={{ zIndex: 69 }} />
    <div className="fixed inset-0 flex items-start justify-center p-4 overflow-y-auto" style={{ zIndex: 70 }}>
