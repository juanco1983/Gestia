...
export const INITIAL_OTS: OT[] = [
  // ── OT-001: CERRADA ─────────────────────────────────────────────────────
  {
    ...
    horaInicioServicio: '09:15',
    horaFinServicio: '11:45',
    tecnicoTitularId: 'user_2',
    tecnicoTitular: 'Carlos Ocsa',
    tecnicoApoyoId: 'user_6',
    tecnicoApoyo: 'Gino Murillo',
    estado: OTStatus.CERRADA,
    origen: 'Contrato' as any,
    otFinancieraId: 'otl_1'
  },
  ...
  // ── OT-002: FIRMADA ─────────────────────────────────────────────────────
  {
    ...
    horaFinProgramada: '13:00',
    horaInicioServicio: '10:10',
    horaFinServicio: '12:50',
    tecnicoTitularId: 'user_5',
    tecnicoTitular: 'Juan Córdova',
    estado: OTStatus.FIRMADA,
    origen: 'Contrato' as any,
    otFinancieraId: 'otl_2'
  },


  // ── OT-004: PROGRAMADA (para hoy) ───────────────────────────────────────
  {
    id: 'OT-004',
    clientId: 'client_1',
    tipoMantenimiento: ServiceType.PREVENTIVO,
  ...
  // ── OT-005: CREADA (sin técnico, sin programación) ──────────────────────
  {
    id: 'OT-005',
    clientId: 'client_3',
    tipoMantenimiento: ServiceType.EMERGENCIA,
    tipoEquipo: EquipmentType.RECTIFICADOR,
    potenciaKva: 120,
    fechaProgramada: '2026-07-05',
    tecnicoTitularId: '',
    tecnicoTitular: '',
    estado: OTStatus.CREADA,
    origen: 'Emergencia' as any
  }
];
