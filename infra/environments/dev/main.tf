##############################################
# AMBIENTE: DEV
# Punto de entrada que orquesta todos los módulos
# Región: us-east-1
##############################################
...
terraform {
  ...
  # ─── Backend Remoto: estado en S3 (debes crear este bucket manualmente 1 vez)
  # Ejecutar primero: aws s3 mb s3://gestia-terraform-state --region us-east-1
  backend "s3" {
