...
2. **Proceso de Aprobación**:
   ...
   - El agente debe esperar a que el usuario valide de forma local en su máquina y dé su aprobación explícitamente.
3. **Fusión de Código (Merge)**:
   - **ÚNICAMENTE** se realiza el merge de la rama `feature` a `dev` cuando el usuario lo pida de forma explícita.
